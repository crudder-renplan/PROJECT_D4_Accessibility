__title__ = 'D4_accessibility'
__version__ = '0.0.0'
__author__ = 'Charles Rudder'
__license__ = 'MIT'
...
def example_function(in_path: Union[str, Path]) -> pd.DataFrame:
    ...
    .. code-block:: python
        ...
        from test_esri_lib import example_function
...
class ExampleObject(object):
    ...
    def example_static_function(in_path: Union[str, Path]) -> pd.DataFrame:
        ...
        .. code-block:: python
            ...
            from test_esri_lib import ExampleObject
    ...
    def example_class_method(cls):
        ...
        .. code-block:: python
            ...
            from from test_esri_lib import ExampleObject
